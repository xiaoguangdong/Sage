...
class AdaptiveFactorWeightSystem:
    ...
    def save_results(self):
        ...
        logger.info("=" * 70)
        latest_weights = self.weights_df.tail(10)[
            ["trade_date", "trend_raw", "momentum_weight", "quality_weight", "liquidity_factor_weight", "risk_weight"]
        ]
        ...
        logger.info("=" * 70)
        print(
            latest_df[["ts_code", "adaptive_score", "momentum_weight", "4w_ret", "12w_ret", "roe_ttm"]]
            .head(20)
