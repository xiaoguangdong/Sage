...
BT_START, BT_END = "2021-02-01", "2024-02-01"
TRAIN_YEARS = [2020]
...
def load_data():
    ...
    frames = []
    for y in TRAIN_YEARS + [2021, 2022, 2023, 2024]:
...
def main():
    ...
    cfg_trend = TrendModelConfig(confirmation_periods=3, exit_tolerance=5, min_hold_periods=7)
    ...
    print(f"\n{'='*80}")
    print(f"2021-2024区间 Top {SHOW_TOP} 选股清单")
    print(f"{'='*80}\n")
