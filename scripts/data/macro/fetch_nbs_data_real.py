...
class NBSDataFetcher:
    ...
    def test_fetch(self):
        ...
        cpi_df = self.fetch_data(
            dbcode="hgyd", rowcode="zb", colcode="sj", zb_code="A0101", sj_code="LAST12"  # 月度数据  # CPI
        )
        ...
        # 测试2：获取PPI数据（全国）
        print("\n测试2：获取PPI数据（全国）...")
        ppi_df = self.fetch_data(dbcode="hgyd", rowcode="zb", colcode="sj", zb_code="A010203", sj_code="LAST12")  # PPI
