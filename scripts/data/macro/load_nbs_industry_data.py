...
if __name__ == "__main__":
    ...
    q4_2024 = result["industry_ppi"][
        (result["industry_ppi"]["date"].dt.quarter == 4) & (result["industry_ppi"]["date"].dt.year == 2024)
    ]
    print(q4_2024[["sw_industry", "date", "ppi_yoy"]].to_string(index=False))

    print("\n申万行业FAI数据（2024年Q4）:")
    q4_2024_fai = result["industry_fai"][
        (result["industry_fai"]["date"].dt.quarter == 4) & (result["industry_fai"]["date"].dt.year == 2024)
    ]
