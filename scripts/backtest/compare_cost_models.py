...
def run_comparison():
    ...
    print("-" * 80)
    print(f"{'总收益':<20} | {result1.metrics['total_return']:>11.2%} | {result2.metrics['total_return']:>11.2%} | {result3.metrics['total_return']:>11.2%}")
    print(f"{'年化收益':<20} | {result1.metrics['annual_return']:>11.2%} | {result2.metrics['annual_return']:>11.2%} | {result3.metrics['annual_return']:>11.2%}")
    print(f"{'夏普比率':<20} | {result1.metrics['sharpe']:>12.2f} | {result2.metrics['sharpe']:>12.2f} | {result3.metrics['sharpe']:>12.2f}")
    print(f"{'最大回撤':<20} | {result1.metrics['max_drawdown']:>11.2%} | {result2.metrics['max_drawdown']:>11.2%} | {result3.metrics['max_drawdown']:>11.2%}")
