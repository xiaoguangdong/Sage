...
class WalkForwardBacktest:
    ...
    def run_backtest(
        self, df: pd.DataFrame, trend_model, rank_model, entry_model, portfolio_constructor, risk_control
    ) -> Dict:
        """
        运行回测
        ...
        for i, (train_start, train_end, test_start, test_end) in enumerate(splits):
            ...
            window_returns, window_trades = self._run_test_window(
                df_test, trend_model, rank_model, entry_model, portfolio_constructor, risk_control
            )
    ...
    def _run_test_window(
        self, df_test: pd.DataFrame, trend_model, rank_model, entry_model, portfolio_constructor, risk_control
