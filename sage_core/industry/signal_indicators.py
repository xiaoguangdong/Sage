...
class MacroSignal:
    ...
    def __init__(self, data_dir=None):
        self.data_dir = Path(data_dir or str(get_tushare_root() / "macro"))
    ...
    def get_macro_signal(self, spread_threshold=0.5, spread_window=20, spread_mode="threshold"):
        ...
        spread_signal = self.calculate_spread_signal(
            spread_df, threshold=spread_threshold, window=spread_window, mode=spread_mode
        )
...
class IndustryProsperity:
    ...
    def __init__(self, data_dir=None):
        self.data_dir = Path(data_dir or str(get_tushare_root() / "fundamental"))
...
class NorthboundFlow:
    ...
    def __init__(self, data_dir=None):
        self.data_dir = Path(data_dir or str(get_tushare_root() / "northbound"))
...
def calculate_all_signals():
    ...
    return {"macro": macro_result, "prosperity": prosperity_df, "flow": flow_df, "industry_flow": industry_flow_df}
