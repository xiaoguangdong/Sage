...
class CycleDetector:
    ...
    def detect_recovery(
        self, ppi_series: pd.Series, fai_series: pd.Series, inventory_series: Optional[pd.Series] = None
    ) -> Dict:
        """
        检测复苏拐点
        ...
        Returns:
            Dict: 检测结果
        """
        result = {"is_recovery": False, "confidence": 0, "signals": {}, "phase": None}
    ...
    def detect_recession(
        self, ppi_series: pd.Series, fai_series: pd.Series, roe_series: Optional[pd.Series] = None
    ) -> Dict:
        """
        检测衰退拐点
        ...
        Returns:
            Dict: 检测结果
        """
        result = {"is_recession": False, "confidence": 0, "signals": {}, "phase": None}
    ...
    def detect_cycle_phase(
        ...
        Returns:
            Dict: 周期阶段信息
        """
        result = {"phase": None, "confidence": 0, "characteristics": {}}
    ...
    def detect_inflection_points(self, series: pd.Series, method: str = "slope_change") -> List[Tuple[int, str]]:
        """
        检测拐点
    ...
    def _detect_continuous_increase(self, series: pd.Series, periods: int) -> bool:
        """
        检测是否连续增加
    ...
    def _detect_continuous_decrease(self, series: pd.Series, periods: int) -> bool:
        """
        检测是否连续减少
