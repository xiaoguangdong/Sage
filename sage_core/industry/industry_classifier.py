...
class IndustryScenarioClassifier:
    ...
    def _get_default_thresholds(self) -> Dict:
        ...
        """
        return {
            "systemic_recession": {"credit_growth": 9.5, "pmi": 48.5},
            "boom": {"pb_percentile": 80, "turnover_rate": 0.08, "rps_120": 90},
            "recovery": {"ppi_yoy": -2, "pb_percentile": 60},
            "recession": {"ppi_yoy": -5, "fai_yoy": 0, "rev_yoy": 0},
        }
    ...
    def _check_boom(self, data: Dict) -> bool:
        ...
        return (
            pb_percentile > self.thresholds["boom"]["pb_percentile"]
            and turnover_rate > self.thresholds["boom"]["turnover_rate"]
            and rps_120 > self.thresholds["boom"]["rps_120"]
        )
    ...
    def _check_recession(self, data: Dict) -> bool:
        ...
        conditions = [ppi_yoy < self.thresholds["recession"]["ppi_yoy"]]
