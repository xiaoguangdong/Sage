...
│   ├── fetch_industry_data.py      # 获取行业数据
│   ├── clean_macro_data.py         # 清洗宏观数据
│   ├── clean_industry_data.py      # 清洗行业数据
...
from ml_stock_forecast.scripts.fetch_macro_data import MacroDataFetcher
from ml_stock_forecast.scripts.clean_macro_data import MacroDataCleaner
from ml_stock_forecast.scripts.fetch_industry_data import IndustryDataFetcher
from ml_stock_forecast.scripts.clean_industry_data import IndustryDataCleaner
...
```bash
# 每周一凌晨2点更新数据
0 2 * * 1 cd /path/to/project && venv/bin/python ml_stock_forecast/scripts/run_macro_prediction.py --mode fetch

# 每周三凌晨2点运行预测
0 2 * * 3 cd /path/to/project && venv/bin/python ml_stock_forecast/scripts/run_macro_prediction.py --mode predict
```
