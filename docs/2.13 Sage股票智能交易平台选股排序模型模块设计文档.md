...
- 特征（10个）：roe, roe_5y_avg, debt_ratio, interest_coverage, consecutive_dividend, dividend_yield, pe_relative, fund_holders, inst_holding_change, revenue_growth
- 标签：未来6个月收益率

**成长股选股器**：
- 硬规则：营收CAGR > 15%, 研发费用率 > 3%, 负债率 < 60%, 非ST
- 特征（10个）：revenue_cagr_3y, profit_cagr_3y, rd_ratio, gross_margin, gross_margin_trend, asset_turnover, roe, industry_rank, fund_holders, inst_holding_change
- 标签：未来6个月收益率
