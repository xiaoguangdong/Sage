...
- `scripts/data/tushare_downloader.py` - 指数数据下载（`--task index_ohlc`）
...
```bash
# 下载2018-2026年指数数据
python scripts/data/tushare_downloader.py --task index_ohlc --start-date 20180101 --end-date 20260209
```
...
- `scripts/data/tushare_downloader.py` - 数据下载（`--task index_ohlc`）
