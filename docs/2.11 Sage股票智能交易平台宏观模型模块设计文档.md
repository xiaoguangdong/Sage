...
- 映射来源：`config/nbs_product_sw_mapping.yaml`（基于统计局目录说明 + GB/T 4754-2017）。
 - 三次映射脚本：`scripts/data/macro/build_nbs_product_mapping.py`
...
### 3.2 现有实现与落地
- 核心信号实现：`sage_core/industry/signal_indicators.py`
...
## 5. 与现有代码映射
- `sage_core/industry/macro_predictor.py`
- `sage_core/industry/industry_classifier.py`
- `sage_core/industry/cycle_detector.py`
- `sage_core/industry/signal_indicators.py`
